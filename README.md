...
| Core | Performance | ISA | Fabric Size | Notes | Status |
|------|-------------|-----|-------------|-------|--------|
| [Anvil-Ultra](https://github.com/JohnH2448/Anvil-Ultra) | High | RV32I | Large | Full Out-of-Order | Coming soon |
...
Fabric size is relative within the Anvil family rather than an absolute FPGA utilization claim.
